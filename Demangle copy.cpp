...
swift::Demangle::DemanglerPrinter &swift::Demangle::DemanglerPrinter::operator<<(unsigned long long n) & {
	char buffer[32];
	snprintf(buffer, sizeof(buffer), "%llu", n);
	Stream.append(buffer);
	return *this;
}
swift::Demangle::DemanglerPrinter &swift::Demangle::DemanglerPrinter::operator<<(long long n) & {
	char buffer[32];
...
static swift::Demangle::DemanglerPrinter &operator<<(swift::Demangle::DemanglerPrinter &printer,
...
namespace {
	struct FindPtr {
		...
		bool operator()(swift::Demangle::NodePointer sp) const {
...
static std::string archetypeName(Node::IndexType index,
	...
	swift::Demangle::DemanglerPrinter name;
	do {
...
namespace {
	...
	class NameSource {
		llvm::StringRef Text;
	public:
		NameSource(llvm::StringRef text) : Text(text) {}
  ...
  /// Claim the next few characters if they exactly match the given string.
		bool nextIf(llvm::StringRef str) {
  ...
  /// that there are at least so many characters.
		llvm::StringRef slice(size_t len) { return Text.substr(0, len); }
		
  /// Return the current string ref without claiming any characters.
		llvm::StringRef str() { return Text; }
  ...
  bool readUntil(char c, std::string &result) {
	...
	static llvm::StringRef toString(swift::Demangle::Directness d) {
  switch (d) {
  ...
  unreachable("bad directness");
	...
	static StringRef toString(swift::Demangle::ValueWitnessKind k) {
  switch (k) {
	  case swift::Demangle::ValueWitnessKind::AllocateBuffer:
    return "allocateBuffer";
	  case swift::Demangle::ValueWitnessKind::AssignWithCopy:
    return "assignWithCopy";
	  case swift::Demangle::ValueWitnessKind::AssignWithTake:
    return "assignWithTake";
	  case swift::Demangle::ValueWitnessKind::DeallocateBuffer:
    return "deallocateBuffer";
	  case swift::Demangle::ValueWitnessKind::Destroy:
    return "destroy";
	  case swift::Demangle::ValueWitnessKind::DestroyBuffer:
    return "destroyBuffer";
	  case swift::Demangle::ValueWitnessKind::InitializeBufferWithCopyOfBuffer:
    return "initializeBufferWithCopyOfBuffer";
	  case swift::Demangle::ValueWitnessKind::InitializeBufferWithCopy:
    return "initializeBufferWithCopy";
	  case swift::Demangle::ValueWitnessKind::InitializeWithCopy:
		  return "initializeWithCopy";
	  case swift::Demangle::ValueWitnessKind::InitializeBufferWithTake:
    return "initializeBufferWithTake";
	  case swift::Demangle::ValueWitnessKind::InitializeWithTake:
    return "initializeWithTake";
	  case swift::Demangle::ValueWitnessKind::ProjectBuffer:
    return "projectBuffer";
	  case swift::Demangle::ValueWitnessKind::InitializeBufferWithTakeOfBuffer:
    return "initializeBufferWithTakeOfBuffer";
	  case swift::Demangle::ValueWitnessKind::DestroyArray:
    return "destroyArray";
	  case swift::Demangle::ValueWitnessKind::InitializeArrayWithCopy:
    return "initializeArrayWithCopy";
	  case swift::Demangle::ValueWitnessKind::InitializeArrayWithTakeFrontToBack:
    return "initializeArrayWithTakeFrontToBack";
	  case swift::Demangle::ValueWitnessKind::InitializeArrayWithTakeBackToFront:
    return "initializeArrayWithTakeBackToFront";
	  case swift::Demangle::ValueWitnessKind::StoreExtraInhabitant:
    return "storeExtraInhabitant";
	  case swift::Demangle::ValueWitnessKind::GetExtraInhabitantIndex:
    return "getExtraInhabitantIndex";
	  case swift::Demangle::ValueWitnessKind::GetEnumTag:
    return "getEnumTag";
	  case swift::Demangle::ValueWitnessKind::DestructiveProjectEnumData:
  ...
  unreachable("bad value witness kind");
	...
	class Demangler {
  std::vector<swift::Demangle::NodePointer> Substitutions;
  NameSource Mangled;
	public:
...
unsigned(*_kind)));     \
  ...
  /// \return true if the mangling succeeded
		swift::Demangle::NodePointer demangleTopLevel() {
	  ...
	  return topLevel;
		...
		swift::Demangle::NodePointer demangleTypeName() {
	  return demangleType();
  }
  ...
  enum class IsVariadic {
	  yes = true, no = false
		...
		llvm::Optional<swift::Demangle::Directness> demangleDirectness() {
	  if (Mangled.nextIf('d'))
		  return swift::Demangle::Directness::Direct;
	  if (Mangled.nextIf('i'))
		  return swift::Demangle::Directness::Indirect;
	  return None;
  }
  ...
  bool demangleBuiltinSize(Node::IndexType &num) {
	  ...
	  return false;
		...
		llvm::Optional<swift::Demangle::ValueWitnessKind> demangleValueWitnessKind() {
	  if (!Mangled)
		  return None;
	  ...
	  return None;
		...
		swift::Demangle::NodePointer demangleGlobal() {
	  if (!Mangled)
		  return nullptr;
	  ...
	  return demangleEntity();
		...
		swift::Demangle::NodePointer demangleGenericSpecialization(swift::Demangle::NodePointer specialization) {
...
payload)
  ...
  bool demangleFuncSigSpecializationConstantProp(swift::Demangle::NodePointer parent) {
  ...
  bool demangleFuncSigSpecializationClosureProp(swift::Demangle::NodePointer parent) {
  ...
  demangleFunctionSignatureSpecialization(swift::Demangle::NodePointer specialization) {
...
#undef FUNCSIGSPEC_CREATE_PARAM_PAYLOAD
  ...
  swift::Demangle::NodePointer demangleSpecializedAttribute() {
  ...
  swift::Demangle::NodePointer demangleDeclName() {
  ...
  swift::Demangle::NodePointer demangleIdentifier(llvm::Optional<Node::Kind> kind = None) {
	  if (!Mangled)
		  return nullptr;
  ...
  swift::Demangle::NodePointer demangleIndexAsNode(Node::Kind kind = Node::Kind::Number) {
  ...
  swift::Demangle::NodePointer createSwiftType(Node::Kind typeKind, StringRef name) {
	  swift::Demangle::NodePointer type = NodeFactory::create(typeKind);
  ...
  swift::Demangle::NodePointer demangleSubstitutionIndex() {
	  if (!Mangled)
		  return nullptr;
	  if (Mangled.nextIf('o'))
